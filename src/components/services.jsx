...
const services = [
  {
    ...
    title: "Home Loans",
    description:
      "Competitive rates for your dream home with flexible repayment options.",
  },
  {
    icon: CarIcon,
    title: "Auto Loans",
    description:
      "Drive your dream car today with our quick and easy auto financing.",
  },
  {
    icon: CreditCardIcon,
    title: "Personal Loans",
    description:
      "Unsecured loans for any personal need with minimal documentation.",
  },
  {
    icon: GraduationCapIcon,
    title: "Education Loans",
    description:
      "Invest in your future with our comprehensive education financing.",
  },
  {
    icon: BriefcaseIcon,
  ...
  },
  {
    ...
    description:
      "Leverage opportunities with our strategic investment financing.",
  },
];

export function Services() {
  return (
    <section id="services" className="py-16 sm:py-10 lg:py-24 bg-muted/40">
